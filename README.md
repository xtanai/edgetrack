...
\# Mass production only — to achieve market-comparable pricing. As an interim solution, off-the-shelf hardware (e.g., Raspberry Pi 5) and selected self-built components may be used to reduce development cost.
