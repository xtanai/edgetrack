...
I briefly considered pursuing patents, but the tradeoffs didn’t make sense: high cost (and a strong drop in investor interest), legal overhead, slower iteration, and extra friction for users. Instead, I’m building this project as **open source** under the **Apache 2.0 license** to keep it accessible, practical, and fast to improve.
